...
This recipe modifies the git repository settings git-backed content item. This is useful in situations where the git repository has migrated from one location or host to another, or if the branch of the repository has been renamed, deleted, or otherwise changed.
