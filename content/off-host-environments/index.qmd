...
This recipe contains an R Markdown document that presents a table detailing
...
Use the **[`GET /v1/environments`](../../api/#get-/v1/environments)** endpoint
to determine the environments available on your server.
