...
# TODO: fix title so it's not days back but the report period
# plot usage_plot_data using plotly 
fig = px.line(usage_plot_data.to_pandas(), x="day", y="usage", title=f"Total usage for the last {days_back} days", template="plotly_white")
