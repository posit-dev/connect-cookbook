...
This recipe identifies the most used content deployed on the Connect server.
...
1. Identify top N most used content
2. Identify top N content users
3. Identify the top N most publishers, based on useage of content
...
The code sample below yields the top N content users, based on usage over a selected time period.
...
The code sample below yields the top N most publishers, based on usage over a selected time period.
