---
title: Retrieve Content Views 
execute: 
  eval: false
---

This recipe yields summary statistics for views of a content item deployed on Connect.
...
Content view data includes the `user_guid` (or `NA` for anonymous viewers), and access timestamp. Shiny for Python and Shiny for R content usage data also includes session duration.

- For all content *except Shiny for Python and Shiny for R*, the content visits data is exposed at the [`/v1/instrumentation/content/visits` endpoint](https://docs.posit.co/connect/api/#get-/v1/instrumentation/content/visits)
...
::: {.callout-note}
Note that if your Connect version is prior to 2023.10, content visits for Plumber, Voila, Streamlit, Dash, and Bokeh were over-counted in instrumentation metrics. Metrics collected after upgrading to version 2023.10 or greater are accurate.
::: 

This recipe provides methods for:

1. Retrieving overall historical content views
...
The code samples below yields content views data as a data frame.
...
str	                str	                datetime[μs]	    str	               i64	date
"0477855b-caeb-…	"1ec56831-7a34-…	2024-03-19 21:09:03	"2024-03-19T21:…	 1	2024-03-19
"0477855b-caeb-…	"1ec56831-7a34-…	2024-03-19 21:39:07	"2024-03-19T22:…	 1	2024-03-19
"0477855b-caeb-…	"d59e7a7b-9684-…	2024-03-20 00:36:29	"2024-03-20T00:… 	 1	2024-03-20
"0477855b-caeb-…	"1ec56831-7a34-…	2024-03-20 13:50:55	"2024-03-20T14:…	 1	2024-03-20
"0477855b-caeb-…	"1ec56831-7a34-…	2024-03-20 16:43:56	"2024-03-20T16:…	 1	2024-03-20
               …	               …	                  … 	             …	 …	         …
"0477855b-caeb-…	"fc80bd89-4488-…	2024-03-28 18:26:20	"2024-03-28T18:…	 1	2024-03-28
"0477855b-caeb-…	"fc80bd89-4488-…	2024-03-28 20:53:50	"2024-03-28T20:…	 1	2024-03-28
"0477855b-caeb-…	"cbee884e-f940-…	2024-03-29 16:13:44	"2024-03-29T16:…	 1	2024-03-29
"0477855b-caeb-…	"fc80bd89-4488-…	2024-03-29 18:16:10	"2024-03-29T20:…	 1	2024-03-29
"0477855b-caeb-…	"3dc75833-f6c2-…	2024-04-11 00:36:00	"2024-04-11T00:…	 1	2024-04-11

```
Visits data for non-Shiny content will also include columns identifying `variant_key`, `rendering_id`, `bundle_id`, and `path`. These columns are not used for this recipe.
...
if (type == "shiny" || type == "python-shiny") {
  ...
  visits <- get_usage_static(client,
    content_guid = content_guid,
    from = report_from,
    to = as_of_date,
    limit = Inf
...
### View visits data as a data frame
visits
...
The code samples below yield by-user content visits data as a data frame. 
...
### Make a table of a user's daily visits and combine with total visits
user_daily_visits = (
...
```
shape: (11, 4)
 username	       day	tot_visits	daily_visits
      str	      date	       u32	         u32
"lisa"	    2024-03-20	         4	           2
...
### Join user data with visits data
by_user_visits <- visits |>
...
### View by-user visits data as a data frame
by_user_visits
```
