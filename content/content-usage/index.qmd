...
if type == "shiny" or type == "python-shiny":
  ...
  usage = (
    pl.DataFrame(client.usage.find(content_guid=content_guid, start=report_from.strftime("%Y-%m-%dT%H:%M:%SZ"),
  ...
  usage = (
    pl.DataFrame(client.visits.find(content_guid=content_guid, start=report_from.strftime("%Y-%m-%dT%H:%M:%SZ"),
    end=as_of_date.strftime("%Y-%m-%dT%H:%M:%SZ")))
    .with_columns(
