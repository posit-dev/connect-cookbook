---
title: Retrieve Content Usage Statistics for a Content Item

---

## Description

This recipe yields summary usage statistics for a content item deployed on Connect. This is useful when seeking to understand overall usage trends for a content item, and understanding which users are most active in accessing the content.
...
This recipe yields:
- A dataframe with historical content usage for an item, including by-user identification and session duration for Shiny for Python and Shiny for R content.
- A summary table of content usage by user, including total usage and daily usage.
- A Quarto dashboard with visualizations of the content usage data.
...
1. Retrieving historical content usage.
...
### Example output for a Shiny app
...
The Quarto document below builds visualizations around the data frames retrieved above. This can be deployed in your own environment as is, or customized to your needs.
