...
if type == "shiny" or type == "python-shiny":
  ...
  usage['day'] = usage['started'].dt.floor('D').dt.date

  usage = pl.from_pandas(usage)
  ...
  usage['day'] = usage['time'].dt.floor('D').dt.date
...
(
    ...
    .fmt_nanoplot(
      ...
      options=nanoplot_options(
          ...
          data_area_fill_color = "#CFD9C7", #TODO: this isn't working. Ask Rich.
...
(
  ...
  # .fmt_date(columns="value", rows=['created_time','last_deployed_time'], date_style="iso") # TODO: fix this
)
