...
Invoking `restart` on content that is not interactive will result in an error. To avoid this, check `content_is_interactive`. This is useful if you need to restart multiple content items.
