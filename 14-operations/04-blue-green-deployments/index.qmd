...
Use [Vanity URLs API](/api/#get-/v1/content/-guid-/vanity) to switch traffic between deployments. In this example, we assume that *blue* content has an assigned vanity URL. See [Viewing a Content Items Vanity URL](../../04-content/19-viewing-a-content-items-vanity-url/index.qmd).
