...
Now that you have the content that a group can see, you can use the content GUID in other recipes like [Revoking Access from Groups](../../content-access-controls/revoking-access-from-groups/) to prevent the group (and others) from being able to access that that content.
