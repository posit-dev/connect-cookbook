...
The `departments` object additional information about the tag catgegory, including the `id` field. We will use the `id` field in the next step to create a tag.
