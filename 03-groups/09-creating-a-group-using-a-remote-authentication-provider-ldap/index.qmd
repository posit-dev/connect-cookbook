...
The `connectapi` package has a function to create groups directly. The function searches for a group with the specified prefix on the remote authentication provider, and creates a corresponding group on Connect.
