...
Now that you have the content that a group can see, you can use the content GUID in other recipes like [Revoking Access from Groups](../../05-content-access-controls/08-revoking-access-from-groups/) to prevent the group (and others) from being able to access that that content.
