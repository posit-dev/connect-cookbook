...
This recipe searches for a group in an LDAP authentication provider, then creates a Posit Connect group for that LDAP group.
...
1. The name of the group you want to add
