...
Create tags, which can then be assigned to content items (see [*Assigning tags*](../04-assigning-tags/index.qmd)).
...
Specify the parent tag with its will need the identifier. See [Viewing Tag Information](../01-viewing-tag-information/index.qmd) for details.
...
Pass an object representing the parent tag to the `parent` argument of `create_tag()`. See [Viewing Tag Information](../01-viewing-tag-information/index.qmd) for details.
